...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `agricoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ agricoincore-node add wallet-service');
      console.log('    $ agricoincore-node add agricoin-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ agricoincore-node remove wallet-service');
      console.log('    $ agricoincore-node remove agricoin-api');
      console.log();
    });
